...
export const StandingOrdersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * This endpoint enables to get Standing Orders by AccountId. Supported product types -Personal Current Account, Foreign Currency Accounts.
         * @summary Get Account Standing Orders
         * @param {StandingOrdersApiGetByAccountIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getByAccountId(requestParameters: StandingOrdersApiGetByAccountIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OBReadStandingOrder6>> {
...
export const StandingOrdersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getByAccountId(requestParameters: StandingOrdersApiGetByAccountIdRequest, options?: AxiosRequestConfig): AxiosPromise<OBReadStandingOrder6> {
...
/**
 * Request parameters for getByAccountId operation in StandingOrdersApi.
 * @export
 * @interface StandingOrdersApiGetByAccountIdRequest
 */
export type StandingOrdersApiGetByAccountIdRequest = {
    
    /**
    * AccountId
    * @type {string}
    * @memberof StandingOrdersApiGetByAccountId
    */
...
export class StandingOrdersApiGenerated extends BaseAPI {
     ...
     */
    public getByAccountId(requestParameters: StandingOrdersApiGetByAccountIdRequest, options?: AxiosRequestConfig) {
        return StandingOrdersApiFp(this.configuration).getByAccountId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
