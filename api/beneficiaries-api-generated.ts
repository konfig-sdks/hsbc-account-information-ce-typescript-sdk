...
export const BeneficiariesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * This endpoint enables to get Beneficiaries by AccountId
         * @summary Get Account Beneficiaries
         * @param {BeneficiariesApiGetByAccountIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getByAccountId(requestParameters: BeneficiariesApiGetByAccountIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OBReadBeneficiary5>> {
...
export const BeneficiariesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getByAccountId(requestParameters: BeneficiariesApiGetByAccountIdRequest, options?: AxiosRequestConfig): AxiosPromise<OBReadBeneficiary5> {
...
/**
 * Request parameters for getByAccountId operation in BeneficiariesApi.
 * @export
 * @interface BeneficiariesApiGetByAccountIdRequest
 */
export type BeneficiariesApiGetByAccountIdRequest = {
    
    /**
    * AccountId
    * @type {string}
    * @memberof BeneficiariesApiGetByAccountId
    */
...
export class BeneficiariesApiGenerated extends BaseAPI {
     ...
     */
    public getByAccountId(requestParameters: BeneficiariesApiGetByAccountIdRequest, options?: AxiosRequestConfig) {
        return BeneficiariesApiFp(this.configuration).getByAccountId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
